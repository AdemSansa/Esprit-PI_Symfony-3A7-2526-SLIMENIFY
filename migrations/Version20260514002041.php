 ...
 */
final class Version20260514002041 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE appointment ADD jitsi_url VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE notifications ADD CONSTRAINT FK_6000B0D371F7E88B FOREIGN KEY (event_id) REFERENCES event (id_event) ON DELETE CASCADE');
        ...
        $this->addSql('CREATE INDEX idx_product_category_name ON products (category, name)');
        $this->addSql('ALTER TABLE quiz CHANGE author_id author_id INT NOT NULL');
        $this->addSql('ALTER TABLE registrations ADD participant_location VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE users CHANGE created_at created_at DATETIME NOT NULL, CHANGE is_verified is_verified TINYINT NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE notification (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, message TEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, is_read TINYINT DEFAULT 0, created_at DATETIME DEFAULT CURRENT_TIMESTAMP, user_id INT DEFAULT NULL, blog_id INT DEFAULT NULL, INDEX fk_notification_blog (blog_id), INDEX fk_notification_user (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('ALTER TABLE appointment DROP jitsi_url');
        $this->addSql('ALTER TABLE blog ADD author_id INT DEFAULT 0');
        ...
        $this->addSql('DROP INDEX idx_product_category_name ON products');
        ...
        $this->addSql('ALTER TABLE registrations DROP participant_location');
        $this->addSql('ALTER TABLE users CHANGE created_at created_at DATETIME DEFAULT CURRENT_TIMESTAMP, CHANGE is_verified is_verified TINYINT DEFAULT 0');
    }
}
